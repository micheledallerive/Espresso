...
TEST(JSONObject, AddMultiple) {
  JSONObject object;
  object["test"] = std::make_shared<JSONLiteral>("test");
  object["test2"] = std::make_shared<JSONLiteral>("test2");
...
TEST(JSONObject, AddObjectWithValue) {
  JSONObject object;
  auto other = std::make_shared<JSONObject>();
  (*other)["test"] = std::make_shared<JSONLiteral>("test");
  object["test"] = other;
